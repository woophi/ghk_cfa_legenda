  ...
  useTimeout(
    () =>
      window.location.replace(
        'alfabank://webFeature?type=recommendation&url=https://dfa.alfabank.ru/retail-investor/webview/?channel=df5',
      ),
    5000,
  );
  return (
    <>
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          block
          view="primary"
          href="alfabank://webFeature?type=recommendation&url=https://dfa.alfabank.ru/retail-investor/webview/?channel=df5"
        >
          Буду ждать!
        </ButtonMobile>
      </div>

...
export const App = () => {
  ...
  const [modalData, setModalData] = useState<{ title: string; subtitle: ReactNode }>({ title: '', subtitle: '' });
  ...
  const openModal = useCallback((data: { title: string; subtitle: ReactNode }) => {
    setModalData(data);
    setOpen(true);
  }, []);
  ...
  return (
    <>
                  ...
                  <>
                    <div>
                      ...
                      <Typography.Text tag="p" view="primary-medium" defaultMargins={false}>
                        зафиксированная на уровне определенного значения
                      </Typography.Text>
                    </div>
                    <div>
                      <Typography.Title tag="h3" view="xsmall" weight="semibold">
                      ...
                      <Typography.Text tag="p" view="primary-medium" defaultMargins={false}>
                        находится в зависимости от определенной переменной и может изменяться
                      </Typography.Text>
                    </div>
                    <div>
                      <Typography.Title tag="h3" view="xsmall" weight="semibold">
                      ...
                      <Typography.Text tag="p" view="primary-medium" defaultMargins={false}>
                        находится в зависимости от определенной переменной и при этом не может быть ниже и/или выше уровня
                        определенного зафиксированного значения
                      </Typography.Text>
                    </div>
                  </>
                ),
      ...
      <BottomSheet
        ...
        hasCloser
      >
        {typeof modalData.subtitle === 'string' ? (
          <Typography.Text tag="p" view="primary-medium" defaultMargins={false}>
            {modalData.subtitle}
          </Typography.Text>
        ) : (
